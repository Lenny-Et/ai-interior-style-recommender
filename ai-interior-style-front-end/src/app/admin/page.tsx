...
const POPULAR_STYLES = [
  { name: "Minimalist",   count: 2840 },
  { name: "Scandinavian", count: 1920 },
  { name: "Modern",       count: 1740 },
  { name: "Bohemian",     count: 1210 },
  { name: "Industrial",   count: 980  },
];
          ...
          <div className="p-4 h-48">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={POPULAR_STYLES} layout="vertical">
                ...
                <YAxis dataKey="name" type="category" tick={{ fill: "#a78bba", fontSize: 11 }} axisLine={false} tickLine={false} width={80} />
                <Tooltip contentStyle={{ background: "#1a1028", border: "1px solid #2d1f42", borderRadius: "12px", color: "#f3e8ff" }} />
